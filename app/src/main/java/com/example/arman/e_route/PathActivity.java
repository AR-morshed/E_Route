...
public class PathActivity extends FragmentActivity implements OnMapReadyCallback,DirectionFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFindPath1 = (Button) findViewById(R.id.btnFindPath);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng hcmus = new LatLng(23.805693, 90.364645);
    ...
    @Override
    public void onDirectionFinderSuccess(List<RouteMap> routes) {
